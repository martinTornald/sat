...
$this->title = 'Loading View ' . $model->voyage_id . '';
...
<div class="loading-view">
    ...
    <p class='pull-left'>
        ...
        ['class' => 'btn btn-info']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Loading', ['create'], ['class' => 'btn
        btn-success']) ?>
    </p>
    ...
    <?php $this->beginBlock('app\modules\admin\models\Loading'); ?>
    ...
    \yii\bootstrap\Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> Loading',
    'content' => $this->blocks['app\modules\admin\models\Loading'],
    'active'  => true,
], ]
                 ]
    );
