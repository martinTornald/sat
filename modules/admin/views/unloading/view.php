...
<div class="unloading-view">
    ...
    <p class='pull-left'>
        ...
        ['class' => 'btn btn-info']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Unloading', ['create'], ['class' => 'btn
        btn-success']) ?>
    </p>
    ...
    <?php $this->beginBlock('app\modules\admin\models\Unloading'); ?>
    ...
    \yii\bootstrap\Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> Unloading',
    'content' => $this->blocks['app\modules\admin\models\Unloading'],
    'active'  => true,
], ]
                 ]
    );
